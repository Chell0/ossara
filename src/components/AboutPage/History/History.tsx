        ...
        <>
            <section className={`flex flex-col md:flex-row items-center gap-10 py-10 mx-10 mt-20`}>
                ...
                <div className="w-full md:w-1/2">
                    <h2 className="text-3xl font-bold text-orange-600">Über Gechichte</h2>
                    <p className="mt-4 text-gray-500">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus elementum accumsan fermentum.
                        Pellentesque suscipit vestibulum est eget scelerisque. Nunc faucibus lacus sed nibh fermentum
                        lobortis. Vestibulum risus urna, feugiat ut sem a, condimentum rhoncus nunc. Curabitur vehicula
                        venenatis ipsum vel bibendum. Sed vitae erat ipsum. Maecenas malesuada nisl at congue vehicula.
