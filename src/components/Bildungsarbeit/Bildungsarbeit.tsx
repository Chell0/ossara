        ...
        <>
            <div className="container mx-auto p-6">
                <header
                    ...
                    <h1 className={`${bebasNeue.className} text-header font-bold leading-tight uppercase`}>
                ...
                <section className="flex flex-col md:flex-row items-center gap-10 py-10 mx-10 mt-20 mb-20">
                    <div className="w-full md:w-1/2">
                        <h2 className="text-3xl font-bold text-orange-600">
                            <Link href="https://machtbewusst-hamburg.de" target="_blank" rel="noopener noreferrer">Machtbewusst-Hamburg</Link>
                        </h2>
                ...
                <section className="flex flex-col md:flex-row items-center gap-10 py-10 mx-10 mt-20 mb-20">
                    <div className="w-full md:w-1/2">
                        <h2 className="text-3xl font-bold text-orange-600">
                            <Link href="/eine_welt_promotorinnen">Eine Welt-Promotorinnen Program</Link>
                        </h2>
                        <p className="mt-4 text-gray-700">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus elementum accumsan
                            fermentum.
