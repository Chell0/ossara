      ...
      <div>
        ...
        <header className="relative min-h-fit w-full pb-8 xs:pb-10 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-24">
          ...
          <div className="absolute inset-0 flex items-start justify-start">
            <h1 className="3xl:pt-44 pt-16 xs:pt-20 3xl:pl-20 pl-4 xs:pl-6 font-extrabold 3xl:text-[10rem] text-[#fcc41b] text-xl xs2:text-3xl xs:text-2xl uppercase leading-tight sm:pt-24 sm:pl-6 sm:text-3xl md:pt-28 md:pl-10 md:text-5xl lg:pt-32 lg:pl-12 lg:text-6xl xl:pt-36 xl:pl-14 xl:text-7xl 2xl:pt-40 2xl:pl-16 2xl:text-8xl">
              Downloads.
            </h1>
          </div>
        </header>
        ...
        {/* Download Items */}
        <section className="flex min-h-screen w-full justify-start 3xl:px-20 px-4 xs:px-6 sm:px-6 md:px-10 lg:px-12 xl:px-14 2xl:px-16">
          <div className="w-full max-w-3xl space-y-6 xs:space-y-7 3xl:py-32 py-8 xs:py-10 sm:space-y-7 sm:py-10 md:space-y-10 md:py-16 lg:space-y-12 lg:py-20 xl:space-y-14 xl:py-24 2xl:space-y-16 2xl:py-28">
            {[
              { year: "2023", file: "jahresbericht_2023.pdf" },
              { year: "2022", file: "jahresbericht_2022.pdf" },
              { year: "2021", file: "jahresbericht_2021.pdf" },
              {
                title: "Stellungnahme von der Arbeitsgruppe Anti-Schwarzer Rassismus Hamburg",
                file: "stellungnahme.pdf",
              },
              {
                title: "Wege für bpoc in ausbildung und arbeit bei der stadt Hamburg",
              ...
              >
                <p className="mb-3 text-base text-gray-800 xs:text-lg sm:mb-0 sm:text-lg md:text-2xl lg:text-3xl">
                ...
                >
                  <button className="flex w-full items-center justify-center space-x-2 rounded-lg bg-[#fcc41b] px-4 xs:px-5 py-2 xs:py-3 font-medium text-sm text-white xs:text-base transition-colors hover:bg-[#e6a200] sm:w-auto sm:px-5 sm:py-3 sm:text-base md:px-8 md:py-4 md:text-xl lg:px-10 lg:py-4.5 lg:text-2xl">
                    <svg
