    ...
    return (
        <>
            <div className="container mx-auto p-6">
                ...
                {/* Jahresbericht 2023 */}
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Jahresbericht 2023</h2>
                    <Link
                ...
                {/* Jahresbericht 2022 */}
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Jahresbericht 2022</h2>
                    <Link
                ...
                {/* Jahresbericht 2021 */}
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Jahresbericht 2021</h2>
                    <Link
                ...
                {/* Stellungnahme */}
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Stellungnahme von der Arbeitsgruppe Anti-Schwarzer Rassismus Hamburg</h2>
                    <Link
                ...
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Wege für bpoc in ausbildung und arbeit bei der stadt Hamburg</h2>
                    <Link
                ...
                {/* Ossara e.V. Satzung */}
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Ossara e.V. Satzung</h2>
                    <Link
                ...
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Ossara e.V. Beitrittserklärung oder einmalige Spende</h2>
                    <Link
                ...
                {/* Unser Logo */}
                <div className={`flex justify-between items-center border border-gray-300 rounded-md p-8 shadow-md bg-white max-w-4xl mx-auto mt-10`}>
                    <h2 className={`text-md font-semibold text-gray-800`}>Andere Formate vom Logo sind auf Anfrage erhältlich</h2>
                    <Link
