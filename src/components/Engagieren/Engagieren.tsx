...
export default function Engagieren() {
  return (
    <div>
      ...
      >
        <div className="flex w-full max-w-8xl flex-col items-center justify-center gap-4 xs:gap-5 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12">
          <h2 className="text-center font-semibold text-2xl text-[#fcc41b] xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
            Unsere aktuellen Ausschreibungen
          </h2>
          <p className="mt-2 xs:mt-3 max-w-prose text-center text-base text-gray-800 xs:text-lg sm:mt-4 sm:text-xl md:text-2xl">
            Werde ein Teil von Ossara und setze Dich mit uns für nachhaltige Veränderung ein!
          </p>
          <div className="mt-6 xs:mt-8 grid w-full grid-cols-1 xs:grid-cols-1 gap-4 xs:gap-5 sm:mt-10 sm:grid-cols-2 sm:gap-6 md:mt-12 md:grid-cols-3 md:gap-8 lg:gap-10">
            ...
            {false ? (
              ...
              <div className="col-span-full w-full max-w-3xl p-4 xs:p-6 text-center sm:p-8 md:p-10">
                <p className="font-bold text-black text-sm xs:text-base sm:text-lg md:text-xl">
                  Derzeit haben wir keine offenen Stellen, aber wir freuen uns immer über
                  Initiativbewerbungen! Werde ein Teil von Ossara und setze dich mit uns für
                  nachhaltige Veränderung ein. Schick uns deine Bewerbung – vielleicht gibt es bald
                  eine Gelegenheit, die zu dir passt!
                </p>
                {/* <a
    ...
    p-4 xs:p-6 sm:p-8 md:p-10 lg:p-12 xl:p-14"
      ...
      >
        ...
        >
          <h2 className="font-extrabold text-2xl text-[#fcc41b] xs:text-3xl uppercase leading-tight drop-shadow-md sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
            Werde Mitglied
          </h2>
          <p className="max-w-prose text-center text-base text-white xs:text-lg sm:text-xl md:text-2xl lg:text-3xl">
            Werde Mitglied und unterstütze uns dabei, nachhaltige Veränderungen zu bewirken.
      ...
      <section className="flex min-h-screen w-full items-center justify-center p-4 xs:p-6 sm:p-8 md:p-10 lg:p-12 xl:p-14">
        <div
          id="ehrenamt"
          ...
          <div className="mt-6 xs:mt-8 grid w-full grid-cols-1 xs:grid-cols-1 gap-4 xs:gap-5 sm:mt-10 sm:grid-cols-2 sm:gap-6 md:mt-12 md:grid-cols-3 md:gap-8 lg:gap-10">
            ...
            {false ? (
              ...
              [...Array(3)].map((_, index) => (
                ...
                >
                  <h3 className="font-semibold text-gray-900 text-lg xs:text-xl sm:text-2xl md:text-3xl">
                    Volunteer Role {index + 1}
                  </h3>
                  <p className="mt-2 mb-3 text-gray-800 text-sm xs:text-base sm:text-lg md:text-xl">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aspernatur
                    commodi cum cupiditate, dolore id in libero maxime nostrum perferendis qui rem
                    sunt vitae! Aperiam autem ducimus est id sit?
                  </p>
                  <a
              ...
              <div className="col-span-full w-full max-w-3xl p-4 xs:p-6 text-center sm:p-8 md:p-10">
                <p className="font-bold text-black text-sm xs:text-base sm:text-lg md:text-xl">
                  Derzeit haben wir keine offenen Ehrenamtsstellen, aber wir freuen uns immer über
                  dein Engagement! Werde ein Teil von Ossara und setze dich mit uns für nachhaltige
                  Veränderung ein. Schick uns deine Bewerbung – vielleicht gibt es bald eine
