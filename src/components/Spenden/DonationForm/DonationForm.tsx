  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#fcc41b]">
      ...
      >
        {/* Heading */}
        <h2
          className="text-center font-semibold 3xl:text-8xl text-2xl text-[#fef5db] drop-shadow-sm sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl "
        >
          Deine Spende
        </h2>
        ...
        {/* Description */}
        <p
          className="mt-header 3xl:max-w-6xl max-w-prose text-left 3xl:text-3xl text-black text-xs sm:text-sm md:max-w-3xl md:text-base lg:text-lg xl:max-w-4xl xl:text-xl 2xl:max-w-5xl 2xl:text-2xl "
        >
