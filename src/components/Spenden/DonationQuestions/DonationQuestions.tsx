  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center">
      <div className="container flex flex-col items-center justify-center gap-section">
        {/* Heading */}
        <h2
          className="text-center font-semibold text-2xl text-[#fcc41b] xs:text-3xl leading-tight xs:leading-snug drop-shadow-sm sm:text-4xl sm:leading-normal md:text-5xl lg:text-6xl"
        >
        ...
        {/* Description */}
        <p
          className="mt-header max-w-prose text-center text-black text-sm xs:text-base leading-relaxed sm:text-lg sm:leading-loose md:text-xl"
        >
        ...
        {/* Donation Details */}
        <div
          className="w-full max-w-prose rounded-lg border border-gray-100 bg-white p-4 text-center shadow-md sm:p-6 md:p-8 lg:p-10"
        >
