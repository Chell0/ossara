    ...
    <div className="relative bg-[#fff6ea]">
      <main className="p-6">
        ...
        <div className="container mx-auto mt-20 max-w-screen-md p-10">
          ...
          {/* Event Date */}
          <p className="mt-2 text-base text-gray-800">Wann: 09. September
            2024</p>
          ...
          <p className="mt-3 text-base text-gray-600 leading-relaxed">
            ...
            historischen Bezügen und
            Kontinuitäten des Kolonialismus in der Hamburger Polizei
            auseinandersetzen. Dabei liegt
            der Fokus auf strukturellem Rassismus, wie zum Beispiel Racial
            Profiling, und den
            notwendigen Dekolonisierungsprozessen. Wir werden untersuchen, wie
            die Polizei während
            der Kolonialzeit koloniale Interessen durchsetzte und welche
            Maßnahmen heute
