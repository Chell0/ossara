  ...
  return (
    <div className="relative bg-white">
      <main className="p-2 sm:p-4 md:p-6">
        <NavBar />
        <div className="container mx-auto mt-20 max-w-screen-md rounded-lg bg-[#fff6ea] p-6 shadow-sm sm:mt-26 sm:p-8 md:p-10">
          {/* News Date */}
          <h3 className="mb-4 text-center text-gray-500 text-sm uppercase sm:mb-5 sm:text-base">
            01. Oktober 2024
          </h3>
          ...
          {/* News Image */}
          <div className="mt-6 mb-4 flex items-center justify-center sm:mt-10 sm:mb-5">
            <Image
          ...
          <section className="prose prose-sm sm:prose-base prose-stone prose-a:target:_blank prose-a:rel:noreferrer mx-auto mt-10 max-w-screen-md prose-headings:font-semibold prose-a:text-orange-500 prose-headings:text-orange-500 prose-headings:text-xl sm:mt-20 sm:prose-headings:text-2xl">
            ...
            <ul className="mt-4 ml-6 list-disc space-y-2 font-semibold text-[#eb7b24] text-sm sm:ml-10">
