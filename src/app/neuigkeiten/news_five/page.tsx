    ...
    <div className="relative bg-white">
      <main className="p-6">
        ...
        <div
          ...
          {/* News Date */}
          <h3 className="mb-5 text-center text-gray-500 uppercase">06. November
            2023</h3>
          ...
          <section
            ...
            <p className="mt-4 text-[#eb7b24] text-base">
              <b>Wo?</b> Bücherhalle Altona, Ottenser Hauptstr. 8-10, Mercado
              2. Stock, 22765
              Hamburg
            </p>
            <p className="mt-4 text-base text-gray-800">
              Die anhaltende Präsenz kolonialer Denkweisen und Strukturen ist
              in verschiedenen
              Bereichen unserer Gesellschaft immer noch zu spüren und macht
              sich u.a. in Form von
              rassistischer Diskriminierung, wirtschaftlicher, kultureller und
              politischer
              Ausbeutung sichtbar. Die dekoloniale Perspektive zielt darauf ab,
              die vom
              Kolonialismus geschaffene globale Ungleichheit kritisch zu
              betrachten und die
              bestehenden Machtstrukturen und Hierarchien zu hinterfragen und
              zu dekonstruieren.
              Dies setzt voraus, dass Dekolonisierung als interdisziplinäres
              Querschnittsthema
              behandelt wird, und dazu ermutigt, marginalisierte Stimmen und
              Erfahrungen in den
              Vordergrund zu stellen. Bei unserer Auftaktveranstaltung
              Decolonize Literatur wollen
              wir uns mit dekolonialen Perspektiven auf die Literatur
              beschäftigen und uns kritisch
              mit den heutigen Auswirkungen des Kolonialismus auf die
              Literaturbranche
              auseinandersetzen. Wir analysieren den eurozentrischen Blick auf
              Literatur und werfen
              in den Raum, wie die weiß dominierte Gegenwartsliteratur
              Vorurteile und Stereotypen u.
              a. durch Illustration, Sprache, im Verlagswesen reproduziert und
              wie neue
            ...
            <p className="mt-10 text-base text-gray-800">
              ...
              Anmeldung bitte bis zum 05.11.2023. Die Veranstaltung ist der
              Auftakt einer
              Decolonize-Reihe, die den interkulturellen Dialog und den
